#
# Be sure to run `pod lib lint RadarChartView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of RadarChartView.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'RadarChartView' => ['RadarChartView/Assets/*.png']
  # }
